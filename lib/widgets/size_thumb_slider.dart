...
class CupertinoSizeThumbSlider extends StatefulWidget {
  ...
  ///   the slider.
  const CupertinoSizeThumbSlider({
    Key key,
    @required this.value,
  ...
  @override
  _CupertinoSizeThumbSliderState createState() => _CupertinoSizeThumbSliderState();
...
class _CupertinoSizeThumbSliderState extends State<CupertinoSizeThumbSlider> with TickerProviderStateMixin {
...
class _RenderCupertinoSlider extends RenderConstrainedBox {
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    CupertinoThumbPainter(color: thumbColor).paint(canvas, Rect.fromCircle(center: thumbCenter, radius: 4.0));
  }
